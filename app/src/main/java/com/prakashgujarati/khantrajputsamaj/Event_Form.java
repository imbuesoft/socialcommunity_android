...
public class Event_Form extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivImage = findViewById(R.id.iv_newsimage);
        tvSelectThumbnail = findViewById(R.id.tv_thumbnail);
        tvSelectImage = findViewById(R.id.tv_newsimage);
        edtHeadLine = findViewById(R.id.et_headline);
        edtTitle = findViewById(R.id.et_title);
        edtCategory = findViewById(R.id.et_category);
        edtDetails = findViewById(R.id.et_detailreport);
        edtReference = findViewById(R.id.et_reference);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.iv_thumbnail:
                ...
                break;
            case R.id.tv_thumbnail:

            case R.id.iv_newsimage:
            case R.id.tv_newsimage:
    ...
    private void callAddNewsApi() {
        ...
        Call<BaseResponse> call = apiService.getCreateEventResponse(
                rb_headLine,
                rb_title,
                rb_category,
                rb_details,

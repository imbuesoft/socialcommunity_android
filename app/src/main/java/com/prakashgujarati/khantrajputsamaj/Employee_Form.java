...
public class Employee_Form extends BaseActivity implements View.OnClickListener {
    private AppCompatImageView ivThumbnail;
    private AppCompatTextView logo;
    private AppCompatEditText et_firstname, et_lastname, et_middilename, et_office, et_category,et_designation,et_contactnumber,et_email,et_address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_office = findViewById(R.id.et_office);
    ...
    private void callAddemployeeApi() {
        ...
        if (thumbFile != null) {
            thumbImage = MultipartBody.Part.createFormData("logo",
                    thumbFile.getName(),
        ...
        RequestBody rb_office = RequestBody.create(
                MediaType.parse(Constant.ClickConstant.TEXT_PLAIN), et_office.getText().toString().trim());
        ...
        RequestBody rb_designation = RequestBody.create(
                MediaType.parse(Constant.ClickConstant.TEXT_PLAIN), et_designation.getText().toString().trim());
        RequestBody rb_contactnumber = RequestBody.create(
                MediaType.parse(Constant.ClickConstant.TEXT_PLAIN), et_contactnumber.getText().toString().trim());
        ...
        Call<BaseResponse> call = apiService.getCreateEmployeeResponse(
                rb_firstname,
                rb_middlename,
                rb_category,
                rb_lastname,
